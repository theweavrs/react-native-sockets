 ...
 * gmail.com>
 */
public class HBSSLSocketFactory extends SSLSocketFactory {
	 ...
	 *
	 * @return The current HBSSLSocketFactory instance
	 */
	public HBSSLSocketFactory trustAllCertificates() {
	 ...
	 * @return The current HBSSLSocketFactory instance
	 */
	public HBSSLSocketFactory disableDiffieHellman() {
	 ...
	 * @return The current HBSSLSocketFactory instance
	 */
	public HBSSLSocketFactory disableDiffieHellman(SSLSocketFactory sourceSocketFactory) {
		if (trustingAllCertificates)
			throw new RuntimeException("Cannot combine trustAllCertificates() and disableDiffieHellman(SSLSocketFactory)");
